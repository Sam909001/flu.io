  <!-- Wallet Modal -->
  <div id="walletModalOverlay" class="hidden fixed inset-0 bg-black bg-opacity-50 z-40"></div>
  <div id="walletModal" class="wallet-modal hidden">
    ...
    <div id="walletConnectSection">
      <!-- Fixed WalletConnect icon -->
      <div class="wallet-option" onclick="connectWalletConnect()">
        <div class="wallet-icon">
          <img src="walletconnect-seeklogo.png" alt="walletconnect" class="w-6 h-6">
        </div>
      ...
      <div class="wallet-option" onclick="connectMetaMask()">
        ...
        <span>MetaMask</span>
        <span id="metamaskInstalledBadge" class="installed-badge hidden">INSTALLED</span>
      </div>
    
      <div class="wallet-option" onclick="connectTrustWallet()">
        <div class="wallet-icon">
          <img src="https://trustwallet.com/assets/images/media/assets/TWT.png" width="24" height="24" alt="Trust Wallet">
        </div>
      ...
      <div class="wallet-option" onclick="connectBinanceWallet()">
        <div class="wallet-icon">
          <img src="https://bin.bnbstatic.com/static/images/common/favicon.ico" width="24" height="24" alt="Binance Wallet">
        </div>
      ...
      <div class="wallet-option" onclick="connectCoinbaseWallet()">
        <div class="wallet-icon">
          <img src="https://coinbase.com/favicon.ico" width="24" height="24" alt="Coinbase Wallet">
        </div>
    ...
    <div id="qrCodeContainer" class="qr-container hidden">
      <button onclick="showWalletOptions()" class="mb-4 text-blue-500">
        ← Back to wallets
      </button>
      <h3 class="mb-4">Scan with your wallet</h3>
      <div class="qr-wrapper">
        <img id="qrImage" width="200" height="200" class="mx-auto">
      </div>
      
      <div class="mt-4">
        <p class="mb-2">Or open directly in:</p>
        <div class="flex justify-center gap-3">
          <button onclick="window.location.href='https://metamask.app.link/wc?uri=' + encodeURIComponent(currentWCUri)" 
                  class="bg-orange-500 hover:bg-orange-600 text-white px-3 py-1 rounded">
            MetaMask
          </button>
          <button onclick="window.location.href='https://link.trustwallet.com/wc?uri=' + encodeURIComponent(currentWCUri)" 
  ...
  <script src="https://cdn.jsdelivr.net/npm/@walletconnect/ethereum-provider@2.4.0/dist/umd/index.min.js"></script>
  <script src="https://unpkg.com/@walletconnect/web3-provider@2.8.0/dist/umd/index.min.js"></script>
  <script src="https://unpkg.com/@walletconnect/qrcode-modal@2.7.0/dist/umd/index.min.js"></script>
